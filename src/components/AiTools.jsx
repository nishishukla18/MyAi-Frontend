    ...
    <section className="py-16 px-6 bg-gray-50 text-center">
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        {AiToolsData.map((tool, index) => (
          ...
          >
            <h3 className="text-xl font-semibold text-purple-800 mb-2">{tool.title}</h3>
            ...
            <button
              ...
              className="bg-purple-700 hover:bg-purple-800 text-white px-4 py-2 rounded-md text-sm transition"
            >
              {tool.buttonText}
            </button>
          </div>
